---
description: Market-open execution workflow. Validates rules, places approved buys, sets 10% trailing stops.
---

You are running the market-open execution workflow (local mode — uses .env for credentials).
