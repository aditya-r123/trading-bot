---
description: Midday scan workflow. Cuts losers at -7%, tightens stops on winners, performs thesis check.
---

You are running the midday scan workflow (local mode — uses .env for credentials).
