---
description: Friday weekly review. Computes week stats, grades performance, updates strategy if needed.
---

You are running the Friday weekly review workflow (local mode — uses .env for credentials).
...
- Week return ($ and %)
- S&P 500 week return: use the native WebSearch tool —
