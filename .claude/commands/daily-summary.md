---
description: Daily summary workflow. Computes day P&L, writes EOD snapshot to TRADE-LOG, sends one ClickUp recap.
---

You are running the daily summary workflow (local mode — uses .env for credentials).
